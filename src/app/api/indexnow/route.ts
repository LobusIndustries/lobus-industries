...
const URLS = [
  ...
  `${SITE_URL}/barber-shop-websites`,
  `${SITE_URL}/tutor-websites`,
  `${SITE_URL}/photographer-websites`,
  `${SITE_URL}/bookkeeper-websites`,
  `${SITE_URL}/real-estate-agent-websites`,
  ...
  `${SITE_URL}/blog/do-service-businesses-need-a-website`,
  `${SITE_URL}/blog/local-seo-guide-for-service-businesses`,
  `${SITE_URL}/blog/cleaning-company-marketing-guide`,
];
